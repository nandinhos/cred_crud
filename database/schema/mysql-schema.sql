...
CREATE TABLE `credentials` (
  ...
  KEY `credentials_user_id_validity_index` (`user_id`,`validity`),
  KEY `credentials_secrecy_index` (`secrecy`),
  CONSTRAINT `credentials_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ranks` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ranks_abbreviation_force_unique` (`abbreviation`,`armed_force`),
  KEY `ranks_armed_force_index` (`armed_force`),
  KEY `ranks_armed_force_hierarchy_order_index` (`armed_force`,`hierarchy_order`),
  KEY `ranks_hierarchy_order_index` (`hierarchy_order`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
